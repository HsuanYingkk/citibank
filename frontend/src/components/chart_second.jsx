...
import CanvasJSReact from '../asset/js/canvasjs.stock.react';
                ...
                <div>
                    {
                        ...
                        this.state.isLoaded &&
                        <CanvasJSStockChart containerProps={containerProps} options={options} options2={options2}
