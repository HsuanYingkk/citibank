...
class CanvasJSChart extends React.Component {
	...
	constructor(props) {
		...
		this.containerProps = props.containerProps ? props.containerProps : { width: "130%", position: "relative" };
		this.containerProps.height = props.containerProps && props.containerProps.height ? props.containerProps.height : this.options.height ? this.options.height + "px" : "100px";
